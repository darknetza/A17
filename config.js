...
// Auth information
global.pairNumber = "263713571083";                         // Add your paining number with country code example "916297175943"; 
...
// Owner information
global.Owner = process.env.OWNER ? process.env.OWNER.split(",") : ["263713571083", "27673257892"];
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(",") : ["27673257892", "263713571083"];
global.ownertag = process.env.OWNER_TAG ? process.env.OWNER_TAG.split(",") : ["27673257892"];
global.OwnerName = process.env.OWNER_NAME || "darknet";
...
global.location = process.env.LOCATION || "PLUMTREE, Zimbabwe";
